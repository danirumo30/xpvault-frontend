...
class AuthController {
  Future<int> login(String email, String password) async {
    try {
      final url = Uri.parse("https://xpvaultbackend.es/auth/login");
  ...
  Future<int> signup(String email, String password) async {
    try {
      final url = Uri.parse("https://xpvaultbackend.es/auth/signup");
      final res = await http.post(
        url,
        headers: {"Content-Type": "application/json"},
        body: json.encode({
  ...
  Future<int> resend(String email) async {
    try {
      final url = Uri.parse("https://xpvaultbackend.es/auth/resend");
      final res = await http.post(
        url,
  ...
  Future<int> verifyCode(String email, String code) async {
    try {
      final url = Uri.parse("https://xpvaultbackend.es/auth/verify");
      final res = await http.post(
        url,
        headers: {"Content-Type": "application/json"},
        body: json.encode({
